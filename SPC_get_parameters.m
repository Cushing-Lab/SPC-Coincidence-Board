function [SPCparameters] = SPC_get_parameters()
%SPC_get_parameters- Data Stored in SPCparameters
    ...
    SPCparameters = SPC_DATA_STRUCT;
    SPCparametersStruct = libstruct('s_SPCdata', SPCparameters);
    [ret, SPCparameters] = calllib('spcm64', 'SPC_get_parameters', SPC_MODULE_NUMBER, SPCparametersStruct);
    if(ret<0)
