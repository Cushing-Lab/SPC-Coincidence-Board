...
/*
 CVIDECL means C calling convention - default for C and C++ programs
    means _stdcall calling convention which is required by Visual Basic

 The only difference    SPCstd_.. and SPC_.. functions is calling convention
...
short   SPCstd_init (char *ini_file);

short   SPC_get_init_status(short mod_no);
short   SPCstd_get_init_status(short mod_no);

short   SPC_get_parameters(short mod_no, SPCdata * data);
short   SPCstd_get_parameters(short mod_no, SPCdata * data);

short   SPC_set_parameters(short mod_no, SPCdata *data);
short   SPCstd_set_parameters(short mod_no, SPCdata *data);

short   SPC_get_parameter(short mod_no, short par_id , float * value);
short   SPCstd_get_parameter(short mod_no, short par_id , float * value);

short   SPC_set_parameter(short mod_no, short par_id , float value);
short   SPCstd_set_parameter(short mod_no, short par_id , float value);

short   SPC_configure_memory(short mod_no, short adc_resolution,
                        short no_of_routing_bits, SPCMemConfig  * mem_info);
short   SPCstd_configure_memory(short mod_no, short adc_resolution,
                        short no_of_routing_bits, SPCMemConfig  * mem_info);

short   SPC_fill_memory(short mod_no, long block,long page,
                                   unsigned short fill_value);
short   SPCstd_fill_memory(short mod_no, long block,long page,
                                   unsigned short fill_value);

short   SPC_clear_mom_memory ( short mod_no );
short   SPCstd_clear_mom_memory ( short mod_no );

short   SPC_prepare_time_gates ( short mod_no, short gates_no,
                         short rchan_no, int *gates, short equal_rchan );
short   SPCstd_prepare_time_gates ( short mod_no, short gates_no,
                         short rchan_no, int *gates, short equal_rchan );

short   SPC_read_block(short mod_no, long block, long frame, long page,
                             short from, short to, unsigned short *data);
short   SPCstd_read_block(short mod_no, long block, long frame, long page,
                             short from, short to, unsigned short *data);

short   SPC_read_data_block(short mod_no,long block,long page,
                             short reduction_factor,short from, short to,
                             unsigned short *data);
short   SPCstd_read_data_block(short mod_no,long block,long page,
                             short reduction_factor,short from, short to,
                             unsigned short *data);

short   SPC_write_data_block(short mod_no, long block, long page,
                             short from, short to, unsigned short *data);
short   SPCstd_write_data_block(short mod_no, long block, long page,
                             short from, short to, unsigned short *data);

short   SPC_read_data_frame(short mod_no, long frame,long page,
                                    unsigned short *data);
short   SPCstd_read_data_frame(short mod_no, long frame,long page,
                                    unsigned short *data);

short   SPC_read_data_page(short mod_no, long first_page,long last_page,
                                    unsigned short *data);
short   SPCstd_read_data_page(short mod_no, long first_page,long last_page,
                                    unsigned short *data);

short   SPC_read_mom_data  ( short mod_no, short with_counters,
                                          short first_chan, short last_chan,
                                          unsigned long *data);
short   SPCstd_read_mom_data  ( short mod_no, short with_counters,
                                          short first_chan, short last_chan,
                                          unsigned long *data);

short   SPC_set_page(short mod_no, long page);
short   SPCstd_set_page(short mod_no, long page);

short   SPC_get_sync_state(short mod_no, short *sync_state);
short   SPCstd_get_sync_state(short mod_no, short *sync_state);

short   SPC_get_fifo_usage(short mod_no, float *usage_degree);
short   SPCstd_get_fifo_usage(short mod_no, float *usage_degree);

short   SPC_get_scan_clk_state(short mod_no, short *scan_state);
short   SPCstd_get_scan_clk_state(short mod_no, short *scan_state);

short   SPC_clear_rates(short mod_no);
short   SPCstd_clear_rates(short mod_no);

short   SPC_read_rates(short mod_no, rate_values *rates);
short   SPCstd_read_rates(short mod_no, rate_values *rates);

short   SPC_get_time_from_start(short mod_no, float *time);
short   SPCstd_get_time_from_start(short mod_no, float *time);

short   SPC_get_break_time(short mod_no, float *time);
short   SPCstd_get_break_time(short mod_no, float *time);

short   SPC_get_actual_coltime(short mod_no, float *time);
short   SPCstd_get_actual_coltime(short mod_no, float *time);

short   SPC_test_state(short mod_no, short *state);
short   SPCstd_test_state(short mod_no, short *state);

short   SPC_start_measurement(short mod_no);
short   SPCstd_start_measurement(short mod_no);

short   SPC_pause_measurement(short mod_no);
short   SPCstd_pause_measurement(short mod_no);

short   SPC_restart_measurement(short mod_no);
short   SPCstd_restart_measurement(short mod_no);

short   SPC_stop_measurement(short mod_no);
short   SPCstd_stop_measurement(short mod_no);

short   SPC_enable_sequencer(short mod_no, short enable);
short   SPCstd_enable_sequencer(short mod_no, short enable);

short   SPC_get_sequencer_state(short mod_no, short *state);
short   SPCstd_get_sequencer_state(short mod_no, short *state);

short   SPC_read_gap_time(short mod_no, float *time);
short   SPCstd_read_gap_time(short mod_no, float *time);

short   SPC_get_eeprom_data(short mod_no, SPC_EEP_Data *eep_data);
short   SPCstd_get_eeprom_data(short mod_no, SPC_EEP_Data *eep_data);

short         SPC_write_eeprom_data(short mod_no, unsigned short write_enable,
                                         SPC_EEP_Data *eep_data);
short   SPCstd_write_eeprom_data(short mod_no, unsigned short write_enable,
                                         SPC_EEP_Data *eep_data);

short         SPC_get_adjust_parameters (short mod_no, SPC_Adjust_Para * adjpara);
short   SPCstd_get_adjust_parameters (short mod_no, SPC_Adjust_Para * adjpara);

short         SPC_set_adjust_parameters (short mod_no, SPC_Adjust_Para * adjpara);
short   SPCstd_set_adjust_parameters (short mod_no, SPC_Adjust_Para * adjpara);

                   // for SPC130, SPC6x0, 830, 140, 15x,16x, 131(2), DPC230 modules
short         SPC_read_fifo(short mod_no, unsigned long * count,unsigned short *data);
short   SPCstd_read_fifo(short mod_no, unsigned long * count,unsigned short *data);



/*- DPC modules specific functions ------------------------------------------*/
                     // for DPC230, get additional start offs of the 1st photon
short         SPC_get_start_offset ( short mod_no, short bank,
                                            unsigned long * ticks );
short   SPCstd_get_start_offset ( short mod_no, short bank,
                                               unsigned long * ticks );

short         DPC_fill_memory ( short mod_no, short page, short bank,
                                       unsigned long fill_value);
short        DPCstd_fill_memory ( short mod_no, short page, short bank,
                                       unsigned long fill_value);

short         DPC_read_rates ( short mod_no, rate_values_dpc *rates);
short        DPCstd_read_rates ( short mod_no, rate_values_dpc *rates);


/*- Low level functions -----------------------------------------------------*/
short         SPC_test_id (short mod_no);
short   SPCstd_test_id (short mod_no);

short         SPC_get_version (short mod_no, unsigned short *version);
short   SPCstd_get_version (short mod_no, unsigned short *version);

short         SPC_clear_status_flags ( short mod_no, unsigned short flags );
short   SPCstd_clear_status_flags(short mod_no, unsigned short flags );


/*- Miscellaneous -----------------------------------------------------------*/

short         SPC_get_module_info(short mod_no, SPCModInfo * mod_info);
short   SPCstd_get_module_info(short mod_no, SPCModInfo * mod_info);

short         SPC_close (void);
short   SPCstd_close (void);

short         SPC_set_mode(short mode, short force_use, int *in_use);
short   SPCstd_set_mode(short mode, short force_use, int *in_use);

short         SPC_get_mode (void);
short   SPCstd_get_mode (void);

short         SPC_get_error_string(short error_id,
                                       char * dest_string, short max_length);
short   SPCstd_get_error_string(short error_id,
                                       char * dest_string, short max_length);

short         SPC_read_parameters_from_inifile( SPCdata *data, char *inifile);
short   SPCstd_read_parameters_from_inifile( SPCdata *data, char *inifile);

short         SPC_save_parameters_to_inifile( SPCdata *data,
                       char * dest_inifile, char *source_inifile, int with_comments);
short   SPCstd_save_parameters_to_inifile( SPCdata *data,
                       char * dest_inifile, char *source_inifile, int with_comments);

short         SPC_save_data_to_sdtfile ( short mod_no,
                           unsigned short *data_buf, unsigned long bytes_no,
                           char *sdt_file );
short   SPCstd_save_data_to_sdtfile ( short mod_no,
                           unsigned short *data_buf, unsigned long bytes_no,
                           char *sdt_file );

short         SPC_init_phot_stream ( short fifo_type, char *spc_file,
                         short files_to_use, short stream_type, short what_to_read );
short   SPCstd_init_phot_stream ( short fifo_type, char *spc_file,
                         short files_to_use, short stream_type, short what_to_read );

short         SPC_close_phot_stream ( short stream_hndl );
short   SPCstd_close_phot_stream ( short stream_hndl );

short         SPC_get_phot_stream_info ( short stream_hndl,
                                               PhotStreamInfo *stream_info );
short   SPCstd_get_phot_stream_info ( short stream_hndl,
                                               PhotStreamInfo *stream_info );

short         SPC_get_photon ( short stream_hndl, PhotInfo *phot_info );
short   SPCstd_get_photon ( short stream_hndl, PhotInfo *phot_info );

short         SPC_get_detector_info ( short previous_type, short * det_type,
                                                   char * fname );
short   SPCstd_get_detector_info ( short previous_type, short * det_type,
                                                   char * fname );

short         SPC_convert_dpc_raw_data ( short tdc1_stream_hndl, short tdc2_stream_hndl,
                             short init, char *spc_file, int max_per_call );
short   SPCstd_convert_dpc_raw_data ( short tdc1_stream_hndl, short tdc2_stream_hndl,
                             short init, char *spc_file, int max_per_call );

                     // functions for buffered streams of photons
short         SPC_get_fifo_init_vars ( short mod_no, short *fifo_type,
                       short *stream_type, int *mt_clock, unsigned int *spc_header);
short   SPCstd_get_fifo_init_vars ( short mod_no, short *fifo_type,
                       short *stream_type, int *mt_clock, unsigned int *spc_header);

short         SPC_init_buf_stream ( short fifo_type, short stream_type,
                                           short what_to_read, int mt_clock,
                                              unsigned int   start01_offs );
short   SPCstd_init_buf_stream ( short fifo_type, short stream_type,
                                              short what_to_read, int mt_clock,
                                              unsigned int   start01_offs );

short         SPC_add_data_to_stream ( short stream_hndl, void *buffer,
                                                unsigned int   bytes_no );
short   SPCstd_add_data_to_stream ( short stream_hndl, void *buffer,
                                                unsigned int   bytes_no );

short         SPC_read_fifo_to_stream ( short stream_hndl, short mod_no,
                                   unsigned long * count );
short   SPCstd_read_fifo_to_stream ( short stream_hndl, short mod_no,
                                     unsigned long * count );

short         SPC_get_data_from_stream ( short stream_hndl, void *data_buf,
                                                unsigned long * count );
short   SPCstd_get_data_from_stream ( short stream_hndl, void *data_buf,
                                                unsigned long * count );

short         SPC_get_photons_from_stream ( short stream_hndl,
                                   PhotInfo64 *phot_info, int *phot_no );
short   SPCstd_get_photons_from_stream ( short stream_hndl,
                                 PhotInfo64 *phot_info, int *phot_no );

short         SPC_stream_start_condition ( short stream_hndl,
                              double start_time, unsigned int   start_OR_mask,
                              unsigned int   start_AND_mask );
short   SPCstd_stream_start_condition ( short stream_hndl,
                              double start_time, unsigned int   start_OR_mask,
                              unsigned int   start_AND_mask );

short         SPC_stream_stop_condition ( short stream_hndl,
                              double stop_time, unsigned int   stop_OR_mask,
                              unsigned int   stop_AND_mask );
short   SPCstd_stream_stop_condition ( short stream_hndl,
                              double stop_time, unsigned int   stop_OR_mask,
                              unsigned int   stop_AND_mask );

short         SPC_stream_reset ( short stream_hndl );
short   SPCstd_stream_reset ( short stream_hndl );

short         SPC_get_stream_buffer_size ( short stream_hndl, unsigned short buf_no,
                                                 unsigned int *buf_size);
short   SPCstd_get_stream_buffer_size ( short stream_hndl, unsigned short buf_no,
                                                     unsigned int *buf_size);

short         SPC_get_buffer_from_stream ( short stream_hndl, unsigned short buf_no,
                           unsigned int *buf_size, char *data_buf, short free_buf);
short   SPCstd_get_buffer_from_stream ( short stream_hndl, unsigned short buf_no,
                           unsigned int *buf_size, char *data_buf, short free_buf);
...
short         SPC_LV_get_eeprom_data(short mod_no, char *module_type,
                       char *serial_no, char *date, SPC_Adjust_Para * adjpara);

short         SPC_LV_get_phot_stream_info ( short stream_hndl,
